...
//Define for Current Calculations, Parameters required
#define I_Rb 118.000 // In ohms
...
void SEND_CAN_MESSAGE(){
  ...
  uint8_t CHCU = CHARGING_CURRENT * 10; 
...
void loop(){
  ...
  //Current Measurement function
    CHARGING_CURRENT = currentSense(Vref, I_Rb, 8, A2);
